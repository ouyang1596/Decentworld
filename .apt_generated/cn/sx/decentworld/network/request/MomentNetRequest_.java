...
public final class MomentNetRequest_
    extends MomentNetRequest
{

    private Context context_;

    private MomentNetRequest_(Context context) {
        context_ = context;
        init_();
    }
    ...
    public static MomentNetRequest_ getInstance_(Context context) {
        return new MomentNetRequest_(context);
    }
