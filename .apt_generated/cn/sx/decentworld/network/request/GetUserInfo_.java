...
public final class GetUserInfo_
    extends GetUserInfo
{

    private Context context_;

    private GetUserInfo_(Context context) {
        context_ = context;
        init_();
    }
    ...
    public static GetUserInfo_ getInstance_(Context context) {
        return new GetUserInfo_(context);
    }
