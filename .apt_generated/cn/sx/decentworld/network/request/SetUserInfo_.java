...
public final class SetUserInfo_
    extends SetUserInfo
{

    private Context context_;

    private SetUserInfo_(Context context) {
        context_ = context;
        init_();
    }
    ...
    public static SetUserInfo_ getInstance_(Context context) {
        return new SetUserInfo_(context);
    }
