...
public final class PrivacySettingInfo_
    extends PrivacySettingInfo
{

    private Context context_;

    private PrivacySettingInfo_(Context context) {
        context_ = context;
        init_();
    }
    ...
    public static PrivacySettingInfo_ getInstance_(Context context) {
        return new PrivacySettingInfo_(context);
    }
