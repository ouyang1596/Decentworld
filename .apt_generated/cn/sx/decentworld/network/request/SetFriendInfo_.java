...
public final class SetFriendInfo_
    extends SetFriendInfo
{

    private Context context_;

    private SetFriendInfo_(Context context) {
        context_ = context;
        init_();
    }
    ...
    public static SetFriendInfo_ getInstance_(Context context) {
        return new SetFriendInfo_(context);
    }
