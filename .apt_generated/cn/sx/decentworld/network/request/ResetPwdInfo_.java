...
public final class ResetPwdInfo_
    extends ResetPwdInfo
{

    private Context context_;

    private ResetPwdInfo_(Context context) {
        context_ = context;
        init_();
    }
    ...
    public static ResetPwdInfo_ getInstance_(Context context) {
        return new ResetPwdInfo_(context);
    }
