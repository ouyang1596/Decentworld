...
public final class ToastComponent_
    extends ToastComponent
{

    private Context context_;
    private static ToastComponent_ instance_;

    private ToastComponent_(Context context) {
        context_ = context;
        init_();
    }
    ...
    public static ToastComponent_ getInstance_(Context context) {
        if (instance_ == null) {
            instance_ = new ToastComponent_(context.getApplicationContext());
        }
        return instance_;
    }
