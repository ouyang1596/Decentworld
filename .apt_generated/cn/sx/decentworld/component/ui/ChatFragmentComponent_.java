...
public final class ChatFragmentComponent_
    extends ChatFragmentComponent
{

    private Context context_;

    private ChatFragmentComponent_(Context context) {
        context_ = context;
        init_();
    }
    ...
    public static ChatFragmentComponent_ getInstance_(Context context) {
        return new ChatFragmentComponent_(context);
    }
