...
public final class ChatRoomChatComponent_
    extends ChatRoomChatComponent
{

    private Context context_;

    private ChatRoomChatComponent_(Context context) {
        context_ = context;
        init_();
    }
    ...
    public static ChatRoomChatComponent_ getInstance_(Context context) {
        return new ChatRoomChatComponent_(context);
    }
