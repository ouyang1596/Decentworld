...
public final class SearchComponent_
    extends SearchComponent
{

    private Context context_;

    private SearchComponent_(Context context) {
        context_ = context;
        init_();
    }
    ...
    public static SearchComponent_ getInstance_(Context context) {
        return new SearchComponent_(context);
    }
