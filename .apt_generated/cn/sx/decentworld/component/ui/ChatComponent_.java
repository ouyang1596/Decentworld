...
public final class ChatComponent_
    extends ChatComponent
{

    private Context context_;

    private ChatComponent_(Context context) {
        context_ = context;
        init_();
    }
    ...
    public static ChatComponent_ getInstance_(Context context) {
        return new ChatComponent_(context);
    }
