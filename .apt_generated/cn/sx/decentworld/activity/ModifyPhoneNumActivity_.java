...
public final class ModifyPhoneNumActivity_
    extends ModifyPhoneNumActivity
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(layout.activity_modify_phone_num);
    }
            ...
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ModifyPhoneNumActivity_.this.back();
                    }
    ...
    public static ModifyPhoneNumActivity_.IntentBuilder_ intent(Context context) {
        return new ModifyPhoneNumActivity_.IntentBuilder_(context);
    }
    ...
    public static class IntentBuilder_ {
        ...
        public IntentBuilder_(Context context) {
            context_ = context;
            intent_ = new Intent(context, ModifyPhoneNumActivity_.class);
        }
        ...
        public ModifyPhoneNumActivity_.IntentBuilder_ flags(int flags) {
