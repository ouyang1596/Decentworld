...
public class ReconnectionManager extends AbstractConnectionListener {
    ...
    public static final String ReconnectThread = "Smack Reconnection Manager";
    ...
    // Add by Jackchen:用来标记重连的次数和等待的时间；
    public static int logReconnectCount = 0;
...
//                    attempts++;
                ...
                public void run()
                {
                    ...
                    while (ReconnectionManager.this.isReconnectionAllowed())
                    {
                        ...
                        {
                            //Add by Jackchen:当系统检测到有网络的时候，将连接次数重置，减少两次连接之间的间隔时间
                            if(hasNetwork)
                            {
                                attempts = 0;
