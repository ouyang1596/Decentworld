...
public class RegisterInfoUseless extends Model {
	...
	public RegisterInfoUseless() {

	}

	public RegisterInfoUseless(String dwID) {
		this.dwID = dwID;
	}
	 ...
	 * @return
	 */
	public static RegisterInfoUseless queryByField(String fieldName, String fieldValue) {
		return new Select().from(RegisterInfoUseless.class)
	 ...
	 * @param dwID
	 */
	public static RegisterInfoUseless queryByDwID(String dwID) {
		return new Select().from(RegisterInfoUseless.class).where("dwID=?", dwID)
				.executeSingle();
	}
