...
//    private int send_fail_resend_count = 0;
    public static Map<String, int[]> countMap = new HashMap<String, int[]>();
    ...
    public static void addDWMessag(DWMessage dwMessage)
    {
        ...
        //系统错误，网络错误
        countMap.put(dwMessage.getTxtMsgID(), new int[]{0,0,0});
    }
    ...
    public MsgContext()
    {
        LogUtils.d(TAG, "MsgContext() 构造函数");
    }
