...
public class Constants {
	...
	public static final File FILE_LOCAL = new File(FILE_SDCARD, Constants.IMAGE_PATH);
	...
	public static final String UPDATE_NICKNAME = CONTEXTPATH + "/set/updateNickName";
	public static final String UPDATE_WONTH = CONTEXTPATH + "/set/updateWonth";
	public static final String REQUEST_SEND_MESSAGE = CONTEXTPATH + "/validate/singleChat";
	public static final String REQUEST_SINGLECHAT_CHARGE = CONTEXTPATH + "/charge/singleChat";
	...
	/** 路径 **/
	public static final String HOME_PATH = Environment.getExternalStorageDirectory() + File.separator + "decentworld";
	/** 裁剪图片 **/
	public static final String CLIP_IMAGE = "/clipImage/";
	/** 语音文件夹子路径 **/
	public static final String AUDIO_RECEIVE_PATH = File.separator + "voiceReceive";
	/** 接收到的语音储存路径(单聊/群聊) **/
	public static final String AUDIO_PATH = "/audio/";
	/** 注册中储存相册中的图片 **/
	public static String CAMERA_PATH = "/cameraPic/";
	/** 储存临时文件 **/
	public static final String IMAGE_FILE_LOCATION = Constants.HOME_PATH + "/temp.png";
	/** 图片缩略图子路径 **/
