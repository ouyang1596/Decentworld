 ...
 * 返回提示对话框
 */
public class DialogDeletePicFragment extends DialogFragment implements
		OnClickListener {
	private Dialog m_dialog;
	private static String mMsg;

	public static DialogDeletePicFragment newInstance(String msg) {
		DialogDeletePicFragment adf = new DialogDeletePicFragment();
		mMsg = msg;
		return adf;
	}
	...
	public void onClick(View view) {
		...
		DialogDeletePicFragment.this.dismiss();
	}
