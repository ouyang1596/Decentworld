...
import cn.sx.decentworld.common.ImageCache;
import cn.sx.decentworld.widget.photoview.PhotoView;
import cn.sx.decentworld.widget.photoview.PhotoViewAttacher.OnViewTapListener;
...
//				LoadLocalBigImgTask task = new LoadLocalBigImgTask(getApplicationContext(), uri.getPath(), image, loadLocalPb, ImageUtils.SCALE_IMAGE_WIDTH, ImageUtils.SCALE_IMAGE_HEIGHT);
