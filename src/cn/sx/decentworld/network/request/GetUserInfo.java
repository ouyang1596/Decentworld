...
public class GetUserInfo
{
     ...
     * @param userID
     */
    public void getKey(String userID, final Handler handler, final int requestCode)
    {
        HashMap<String, String> map = new HashMap<String, String>();
        map.put("dwID", userID);
        LogUtils.i(TAG, "getKey...begin,userID=" + userID);
        sendUrl.httpRequestWithParams(map, Constants.CONTEXTPATH + "/security/getKey", Method.GET, new HttpCallBack()
        {
            @Override
            public void onSuccess(String response, ResultBean msg)
            {
     ...
     * @param newKey
     */
    public void uploadKey(String userID, String password, String newKey, final String randomStr, final Handler handler, final int requestCode)
    {
        HashMap<String, String> map = new HashMap<String, String>();
        map.put("dwID", userID);
        ...
        sendUrl.httpRequestWithParams(map, Constants.CONTEXTPATH + "/security/uploadKey", Method.GET, new HttpCallBack()
        {
            @Override
            public void onSuccess(String response, ResultBean msg)
            {
    ...
    public void testKey(String userID, String token, String msg)
    {
        ...
        map.put("token", token);
        map.put("msg", msg);
        LogUtils.i(TAG, "testKey...begin,userID=" + userID + ",token=" + token + ",msg=" + msg);
        sendUrl.httpRequestWithParams(map, Constants.CONTEXTPATH + "/security/testKey", Method.GET, new HttpCallBack()
        {
            @Override
            public void onSuccess(String response, ResultBean msg)
            {
                LogUtils.i(TAG, "testKey...begin,msg.getResultCode=" + msg.getResultCode() + ",msg.getMsg=" + msg.getMsg() + ",msg.getData=" + msg.getData());
                if (msg.getResultCode() == 2222)
                {
                ...
                {
                    LogUtils.i(TAG, "testKey...failure,cause by:" + msg.getMsg());
    ...
    public void getAdvanceAuth(String dwID, final Handler handler, final int requestCode)
    {
        ...
        sendUrl.httpRequestWithParams(map, Constants.CONTEXTPATH + Constants.AUTH_GET, Method.GET, new HttpCallBack()
        {
            ...
            public void onSuccess(String response, ResultBean msg)
            {
                LogUtils.i(TAG, "getAdvanceAuth...begin,msg.getResultCode=" + msg.getResultCode() + ",msg.getMsg=" + msg.getMsg() + ",msg.getData=" + msg.getData());
                if (msg.getResultCode() == 2222)
                {
                    Message message = Message.obtain();
                    message.what = requestCode;
    ...
    public void getAutoAuthority(String dwID, final Handler handler, final int requestCode)
    {
        ...
        sendUrl.httpRequestWithParams(map, Constants.CONTEXTPATH + "/auth/getAutoAuthority", Method.GET, new HttpCallBack()
        {
            @Override
            public void onSuccess(String response, ResultBean msg)
            {
                LogUtils.i(TAG, "getAutoAuthority...begin,msg.getResultCode=" + msg.getResultCode() + ",msg.getMsg=" + msg.getMsg() + ",msg.getData=" + msg.getData());
                if (msg.getResultCode() == 2222)
                {
                    Message message = Message.obtain();
                    message.what = requestCode;
    ...
    public void getMyGr(String userID, final Handler handler, final int requestCode)
    {
        ...
        sendUrl.httpRequestWithParams(map, Constants.CONTEXTPATH + "/user/getMyGR", Method.GET, new HttpCallBack()
        {
            @Override
            public void onSuccess(String response, ResultBean msg)
            {
                LogUtils.i(TAG, "getMyGr...begin,msg.getResultCode=" + msg.getResultCode() + ",msg.getMsg=" + msg.getMsg() + ",msg.getData=" + msg.getData());
                if (msg.getResultCode() == 2222)
                {
    ...
    public void extraRecomBenefit(String userID, String pwd, final Handler handler, final int requestCode)
    {
        ...
        sendUrl.httpRequestWithParams(map, Constants.CONTEXTPATH + "/transfer/withdrawBenefit", Method.GET, new HttpCallBack()
        {
            @Override
            public void onSuccess(String response, ResultBean msg)
            {
                LogUtils.i(TAG, "extraRecomBenefit...begin,msg.getResultCode=" + msg.getResultCode() + ",msg.getMsg=" + msg.getMsg() + ",msg.getData=" + msg.getData());
                if (msg.getResultCode() == 2222)
                {
                    LogUtils.i(TAG, "extraRecomBenefit...success");
                    ToastUtils.toast(context, "提取成功");
                    // Message message = Message.obtain();
                    // message.what = requestCode;
                    // message.obj = msg.getData().toString();
                    // handler.sendMessage(message);
