...
public class PrivacySettingInfo {
	...
	public void setBankCard(HashMap<String, String> map, String api,
	...
	public void setPhoneNum(HashMap<String, String> map, String api,
			int method, final Handler handler) {
		showProgressDialog();
		sendUrl.httpRequestWithParams(map, Constants.CONTEXTPATH + api, method,
				new HttpCallBack() {
	...
	public void setNewPassword(HashMap<String, String> map, String api,
			int method, final Handler handler) {
		showProgressDialog();
		sendUrl.httpRequestWithParams(map, Constants.CONTEXTPATH + api, method,
				new HttpCallBack() {
