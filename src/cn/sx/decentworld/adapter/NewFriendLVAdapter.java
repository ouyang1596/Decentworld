...
public class NewFriendLVAdapter extends BaseAdapter implements OnClickListener {
	...
	public void acceptFriend(String dwID, final String friendID) {
		...
		sendUrl.httpRequestWithParams(map, Constants.CONTEXTPATH
				+ "/friend/acceptFriend", Method.GET, new HttpCallBack() {
			...
			public void onSuccess(String response, ResultBean msg) {
				LogUtils.i(
						TAG,
						"acceptFriend...msg.getResultCode="
				...
				if (msg.getResultCode() == 3333) {
					LogUtils.i(TAG,
							"acceptFriend...failure,cause by:" + msg.getMsg());
				}
			}
		});
	}
	...
	public void refuseFriend(String dwID, final String friendID) {
		...
		sendUrl.httpRequestWithParams(map, Constants.CONTEXTPATH
				+ "/friend/refuseFriend", Method.GET, new HttpCallBack() {
			@Override
			public void onFailure(String e) {
			...
			public void onSuccess(String response, ResultBean msg) {
				LogUtils.i(
						TAG,
						"refuseFriend...msg.getResultCode="
								+ msg.getResultCode() + ",msg.getMsg="
								+ msg.getMsg());
				if (msg.getResultCode() == 2222) {
				...
				if (msg.getResultCode() == 3333) {
					LogUtils.i(TAG,
							"refuseFriend...failure,cause by:" + msg.getMsg());
				}
			}
