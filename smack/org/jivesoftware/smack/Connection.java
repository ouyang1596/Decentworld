...
public abstract class Connection {
     ...
     */
    public final Collection<ConnectionListener> connectionListeners =
    ...
    protected final Map<PacketCollectorType, PacketCollector> collectorMap=new ConcurrentHashMap<PacketCollectorType, PacketCollector>();
    ...
    public PacketCollector getPacketCollector(PacketCollectorType type){
    ...
    public void showRecvListeners(){
    	int size=recvListeners.size();
    	Log.i("recvListeners:---->size", String.valueOf(size));
    	Set<PacketListener> set=recvListeners.keySet();
    	for(PacketListener listener:set){
        	Log.i("recvListeners:---->", listener.toString());
    	}
    }
