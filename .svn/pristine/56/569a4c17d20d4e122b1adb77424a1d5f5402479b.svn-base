...
public abstract class XMPPConnection {
     ...
     *Add by Jackchen
     */
    public PacketCollector createPacketCollector(PacketFilter packetFilter,Class<? extends DWPacketHandler> executor) {
        PacketCollector collector = new PacketCollector(this, packetFilter,executor);
        // Add the collector to the list of active collectors.
        collectors.add(collector);
        return collector;
    }
