...
public final class ChoceAndTakePictureComponent_
    extends ChoceAndTakePictureComponent
{

    private Context context_;

    private ChoceAndTakePictureComponent_(Context context) {
        context_ = context;
        init_();
    }
    ...
    public static ChoceAndTakePictureComponent_ getInstance_(Context context) {
        return new ChoceAndTakePictureComponent_(context);
    }
