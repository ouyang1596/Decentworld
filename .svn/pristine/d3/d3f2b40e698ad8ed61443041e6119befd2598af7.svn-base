...
//import cn.sx.decentworld.db.InviteMessgeDao;
//import cn.sx.decentworld.domain.InviteMessage;
//import cn.sx.decentworld.domain.InviteMessage.InviteMesageStatus;
//
//
...
//						cn.sx.decentworld.domain.User user =null;// DecentWorldApp.getInstance().getContactList().get(Constants.NEW_FRIENDS_USERNAME);
