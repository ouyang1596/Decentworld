...
public class UserInfoItemAdapter extends BaseAdapter
{
	...
	public UserInfoItemAdapter(FragmentManager fm, Context context, List<EditUserInfoItem> mDatas)
	{
	...
	public UserInfoItemAdapter(FragmentManager fm, Context context, List<EditUserInfoItem> mDatas, boolean isEdit)
	{
		this.context = context;
		this.mDatas = mDatas;
		inflater = LayoutInflater.from(context);
	...
	public View getView(final int position, View convertView, ViewGroup parent)
	{
		...
		if (convertView == null)
		{
			...
			holder.ll_edit_user_info_item_title_child = (LinearLayout) convertView.findViewById(R.id.ll_edit_user_info_item_title_child);
			...
			else
			{
				...
				holder.rl_content.setOnClickListener(new OnClickListener()
				{
					...
					public void onClick(View v)
					{
						...
						else if (mDatas.get(position).getKey().equals("学校") || mDatas.get(position).getKey().equals("毕业学校"))
						{
							LogUtils.i(TAG, "position=" + position + ",getKey=" + mDatas.get(position).getKey());
						...
						else if (mDatas.get(position).getKey().equals("院系") || mDatas.get(position).getKey().equals("毕业院系"))
						{
							LogUtils.i(TAG, "position=" + position + ",getKey=" + mDatas.get(position).getKey());
						...
						// 既可以自定义，也可以选择
						else if (mDatas.get(position).getKey().equals("宗教") || mDatas.get(position).getKey().equals("特长") || mDatas.get(position).getKey().equals("偶像")
								|| mDatas.get(position).getKey().equals("足迹") || mDatas.get(position).getKey().equals("喜欢的书") || mDatas.get(position).getKey().equals("喜欢的音乐")
								|| mDatas.get(position).getKey().equals("喜欢的电影") || mDatas.get(position).getKey().equals("喜欢的运动") || mDatas.get(position).getKey().equals("美食"))
						{
							LogUtils.i(TAG, "position=" + position + ",getKey=" + mDatas.get(position).getKey());
						...
						// 只可以自定义
						else if (mDatas.get(position).getKey().equals("故乡") || mDatas.get(position).getKey().equals("电话") || mDatas.get(position).getKey().equals("邮箱")
								|| mDatas.get(position).getKey().equals("QQ") || mDatas.get(position).getKey().equals("微信") || mDatas.get(position).getKey().equals("微博")
								|| mDatas.get(position).getKey().equals("车子") || mDatas.get(position).getKey().equals("座右铭"))
						{
							LogUtils.i(TAG, "position=" + position + ",getKey=" + mDatas.get(position).getKey());
						...
						// 只可以选择
						else if (mDatas.get(position).getKey().equals("民族") || mDatas.get(position).getKey().equals("血型") || mDatas.get(position).getKey().equals("星座"))
						{
							LogUtils.i(TAG, "position=" + position + ",getKey=" + mDatas.get(position).getKey());
