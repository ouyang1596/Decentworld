...
public class DisplayAuthority extends Model
{
	...
	public DisplayAuthority(String dwID){
		this.dwID=dwID;
	...
	/**
	 * @param showWealth the showWealth to set
	 */
	...
	/**
	 * @param showWorth the showWorth to set
	 */
	 ...
	 * @param dwID
	 */
	public static DisplayAuthority queryByDwID(String dwID)
	{
		return new Select().from(DisplayAuthority.class).where("dwID=?", dwID).executeSingle();
	}
