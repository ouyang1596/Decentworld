            ...
            else
            {
                ...
                holder.rl_content.setOnClickListener(new OnClickListener()
                {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        // 既可以自定义，也可以选择
                        else if (mDatas.get(position).getIndex().equals("religion") || mDatas.get(position).getIndex().equals("speciality") || mDatas.get(position).getIndex().equals("idol")
                                || mDatas.get(position).getIndex().equals("footprint") || mDatas.get(position).getIndex().equals("likebooks") || mDatas.get(position).getIndex().equals("likemusic")
                                || mDatas.get(position).getIndex().equals("likemovie") || mDatas.get(position).getIndex().equals("likesport")|| mDatas.get(position).getIndex().equals("cate"))
                        {
                            LogUtils.i(TAG, "position=" + position + ",getKey=" + mDatas.get(position).getKey());
                        ...
                        // 只可以自定义
                        else if (mDatas.get(position).getIndex().equals("hometown") || mDatas.get(position).getIndex().equals("phoneNum") || mDatas.get(position).getIndex().equals("email")
                                || mDatas.get(position).getIndex().equals("qq") || mDatas.get(position).getIndex().equals("wechat") || mDatas.get(position).getIndex().equals("blog")
                                || mDatas.get(position).getIndex().equals("vehicle") || mDatas.get(position).getIndex().equals("motto")
                        ...
                        // 只可以选择
                        else if (mDatas.get(position).getIndex().equals("nation") || mDatas.get(position).getIndex().equals("bloodType") || mDatas.get(position).getIndex().equals("constellatory"))
                        {
                            LogUtils.i(TAG, "position=" + position + ",getKey=" + mDatas.get(position).getKey());
