...
public class MultiUserChat
{
	...
	static
	{
		Connection.addConnectionCreationListener(new ConnectionCreationListener()
		{
			...
			{
				// Set on every established connection that this client supports
				// the Multi-User
				// Chat protocol. This information will be used when another
				// client tries to
				...
				// Set the NodeInformationProvider that will provide information
				// about the
	...
	private void checkPresenceCode(String code, boolean isUserModification, MUCUser mucUser, String from)
	{
		...
		if ("307".equals(code))
		{
			...
			if (isUserModification)
			{
				...
				{ mucUser.getItem().getActor(), mucUser.getItem().getReason() });
