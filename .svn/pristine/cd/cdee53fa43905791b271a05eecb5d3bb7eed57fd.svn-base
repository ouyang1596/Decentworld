    ...
    extends MeSettingActivity
{
    ...
    private void afterSetContentView_() {
        ...
        {
            View view = findViewById(id.ll_me_setting_magnate_to_me);
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    @Override
                    public void onClick(View view) {
                        MeSettingActivity_.this.MagnateToMe();
                    }
        ...
        {
            View view = findViewById(id.ll_me_setting_cash_income);
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
        ...
        {
            View view = findViewById(id.ll_me_setting_magnate_to_other);
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    @Override
                    public void onClick(View view) {
                        MeSettingActivity_.this.MagnateToOther();
                    }
