...
public final class MeSettingComponent_
    extends MeSettingComponent
{

    private Context context_;

    private MeSettingComponent_(Context context) {
        context_ = context;
        init_();
    }
    ...
    public static MeSettingComponent_ getInstance_(Context context) {
        return new MeSettingComponent_(context);
    }
