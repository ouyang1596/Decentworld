...
public class NotifyByEventBus {
	...
	public static final String NT_REFRESH_STRANGER_CONVERSATION = "NT_REFRESH_STRANGER_CONVERSATION";// 更新陌生人会话列表
	/**
	 * 聊天列表
	 */
	...
	// public static final String NT_RESTART_SERVICE = "NT_RESTART_SERVICE";//
	// 重启服务
	...
	/** 未读消息数 **/
	public static final String NT_UNREAD_CONVERSATION_COUNT = "NT_UNREAD_CONVERSATION_COUNT";// 未读消息数
	public static final String NT_UNREAD_CONTACT_COUNT = "NT_UNREAD_CONTACT_COUNT";// 未读联系人数
	public static final String NT_UNREAD_FIND_COUNT = "NT_UNREAD_FIND_COUNT";// 未读作品圈数
