...
public class MomentImgAdapter extends BaseAdapter
{
     ...
     */
    public MomentImgAdapter(Context context, List<String> imageUrls,int mImgType)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if(mImgType == ImageUtils.IMAGE_FROM_LOCAL)
        {
            //本地图片
            holder.imageView.setImageBitmap(ImageUtils.getLoacalBitmap(imageUrls.get(position)));
        }else
        {
            //服务图片
