...
import cn.sx.decentworld.task.DWPacketHandler;
...
//    private ArrayBlockingQueue<Packet> resultQueue;
    ...
    private Class<? extends DWPacketHandler> executor;
     ...
     * Add by Jackchen
     */
    protected PacketCollector(XMPPConnection connection, PacketFilter packetFilter,Class<? extends DWPacketHandler> executor) {
        this.connection = connection;
        this.packetFilter = packetFilter;
//        this.resultQueue = new LinkedBlockingQueue<Packet>(MAX_PACKETS);
        this.resultQueue = new ArrayBlockingQueue<Packet>(SmackConfiguration.getPacketCollectorSize());
        this.executor=executor;
    }
    /**
     * Add by Jackchen
     */
    public Class<? extends DWPacketHandler> getExecutor(){
    	return executor;
    }
